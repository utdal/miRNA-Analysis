...
m1novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM1_S5.tsv', sep='\t', header=0)
m2novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM2.tsv', sep='\t', header=0)
m4novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM4.tsv', sep='\t', header=0)
f1novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelf1.tsv', sep='\t', header=0)
f2novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelf2.tsv', sep='\t', header=0)
f3novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelf3.tsv', sep='\t', header=0)
f4novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelf4.tsv', sep='\t', header=0)
m20novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM20.csv', sep='\t', header=0)
m10novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM10.csv', sep='\t', header=0)
m21novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM21.csv', sep='\t', header=0)
m22novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM22.csv', sep='\t', header=0)
m23novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM23.csv', sep='\t', header=0)
m24novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM24.csv', sep='\t', header=0)
m26novel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novelM26.csv', sep='\t', header=0)
x80T2Rnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel80T2R.csv', sep='\t', header=0)
x83T8Rnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel83T8R.csv', sep='\t', header=0)
x84T4Lnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel84T4L.csv', sep='\t', header=0)
x84T5Lnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel84T5L.csv', sep='\t', header=0)
x85T3Lnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel85T3L.csv', sep='\t', header=0)
x85T3Rnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel85T3R.csv', sep='\t', header=0)
x85T5Rnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel85T5R.csv', sep='\t', header=0)
x91T5Rnovel = pd.read_csv('/home/sag200006/working_folder/Analysis_Scripts/novel91T5R.csv', sep='\t', header=0)
...
class FilterMiRDeep2Results:
    ...
    similar_hairpin.to_csv('/home/sag200006/working_folder/Analysis_Scripts/similar_hairpin_all_samples.csv', sep='\t')

    only_one.to_csv('/home/sag200006/working_folder/Analysis_Scripts/no_repeat_across_all_samples.csv', sep='\t')